...
export default function Activity() {
  ...
  const [{ items: activities, loading: activitiesLoading }] = useItemsUploader(
    ...activitiesParams
  );
  const [{ items: classifications, loading: classificationsLoading }] =
    useItemsUploader(...classificationParams);
